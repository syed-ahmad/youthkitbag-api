...
router.post('', hasWanted, kitbagValidation, wantedValidation, checkValidationResult, wantedController.add);
router.put('/:wantedId', isWantedOwner, kitbagValidation, wantedValidation, checkValidationResult, wantedController.edit);
