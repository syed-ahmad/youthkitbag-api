...
router.post('', hasTrade, kitbagValidation, tradeValidation, checkValidationResult, tradeController.add);
router.put('/:tradeId', isTradeOwner, kitbagValidation, tradeValidation, checkValidationResult, tradeController.edit);
