...
const groupValidation = [
  ...
  body('tagline', 'Please enter a tagline of at least 5 characters').trim().customSanitizer((value) => value.replace(/ +/g, "-").toLowerCase()).isLength({min: 5}),
  ...
  body('activitys', 'Please specify at least one activity').isArray({min: 1}),
