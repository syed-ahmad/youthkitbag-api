...
module.exports = (req, res, next) => {
  User
    .findById(req.userId)
    .then (user => {
      if (user.package.size.kit >= user.package.max.kit) {
        const error = new Error('You have reached the limit of kit items that you can add to your account. Please upgrade your account.');
